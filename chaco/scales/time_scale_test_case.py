...
class TRangeTestCase(TicksTestCase):
    def test_null_ranges(self):
        ranges = (((2005, 3, 15, 10, 23, 15), (2005, 3, 15, 10, 23, 45), {
            "minutes": 1
        }), ((2005, 3, 15, 10, 23), (2005, 3, 15, 10, 47), {
            "hours": 1
        }), ((2005, 3, 15, 5, 23), (2005, 3, 15, 18, 43), {
            "days": 1
        }), ((2005, 3, 15, 10, 30), (2005, 12, 25, 18, 30), {
            "years": 1
        }))
...
class TimeScaleTestCase(TicksTestCase):
    ...
    def test_day_of_month(self):
        ...
        desired = list(
            starmap(DTS, ((2005, 3, 15), (2005, 3, 22), (2005, 4, 1), (
                2005, 4, 8), (2005, 4, 15), (2005, 4, 22), (2005, 5, 1))))
        self.check_ticks(ts.ticks(start, end), desired)
        ...
        desired = list(
            starmap(DTS, ((2005, 3, 15), (2005, 3, 22), (2005, 4, 1), (2005, 4,
                                                                       8))))
        self.check_ticks(ts.ticks(start, end), desired)
...
class CalendarScaleSystemTestCase(TicksTestCase):
    ...
    def test_yearly_scales(self):
        ...
        desired = list(
            starmap(DTS, ((2000, 1, 1), (2001, 1, 1), (2002, 1, 1), (
...
class TimeFormatterTestCase(TicksTestCase):
    def test_widths(self):
        ...
        for start, end, width in test_intervals:
            ...
            print(start, end, end=' ')
            print(" avail:", width, "est:", est_width[1], "numlabels:",
                  est_width[0])
        return
