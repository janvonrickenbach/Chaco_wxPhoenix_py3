...
class SubdivisionDataMapper(AbstractDataMapper):
    ...
    def _update_datamap(self):
        ...
        if self._data is None:
            ...
            # them in two arrays
            self._cell_lefts = arange(
                ll[0], ll[0] + ur[0] - cell_width / 2, step=cell_width)
            self._cell_bottoms = arange(
                ll[1], ll[1] + ur[1] - cell_height / 2, step=cell_height)
    ...
    def _basic_insertion(self, celltype):
        ...
        for start, end in zip(start_indices, end_indices):
            ...
            if celltype == RangedCell:
                ...
                self._cellgrid[gridx, gridy].add_indices(
